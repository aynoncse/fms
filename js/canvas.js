...
/* Import text remove unicode text start customize by Ayenal start */

	/*  W.obj = Trial version link  */
	/* Canvas js link =  m.creditText   fb function*/
...
(function() {
    ...
    function cb(m) {
        if (!db) {
            var s = !1,
                q = !1;
            "undefined" === typeof qa.Chart.creditHref ? (m.creditHref = ga("iuuqr;..b`ow`rkr/bnl."), m.creditText = ga("")) : (s = m.updateOption("creditText"), q = m.updateOption("creditHref"));
